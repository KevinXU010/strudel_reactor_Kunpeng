      ...
      <div className="card-body">
        <div className="d-grid gap-2">
          <div className="btn-group" role="group" aria-label="Preprocess actions">
            <button onClick={onPreprocess} className="btn btn-info btn-sm">🎛️Preprocess</button>
          ...
          <div className="btn-group" role="group" aria-label="Transport">
            <button onClick={onPlay} className="btn btn-success btn-sm">▶️Play</button>
            <button onClick={onStop} className="btn btn-danger btn-sm">⏹️Stop</button>
          </div>
        </div>
      </div>
    </div> 
